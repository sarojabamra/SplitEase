...
export const renameGroup = asyncHandler(async (request, response) => {
...
export const addToGroup = asyncHandler(async (request, response) => {
...
export const removefromGroup = asyncHandler(async (request, response) => {
  const { chatId, userId } = request.body;
